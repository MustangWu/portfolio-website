    ...
    <section className="bg-transparent mt-10">
      <div className="max-w-screen-xl px-4 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <div className="flex justify-center mt-8 space-x-6">
          ...
          <button
            onClick={copyEmail}
            className="text-gray-400 hover:text-gray-500 relative bg-transparent border-0 p-0 cursor-pointer"
      ...
      <p className="mt-2 text-base leading-6 text-center text-gray-400 pb-4">
        &copy; {currentYear} Mustang
      </p>
